<template>
  <div class="mb-12">
    <div class="text-center mb-8">
      <h2 class="text-h4 font-weight-black text-grey-darken-4 mb-2">Related Bus</h2>
      <p class="text-subtitle-1 text-grey-darken-1 mb-0">Similar Options You May Like</p>
    </div>
